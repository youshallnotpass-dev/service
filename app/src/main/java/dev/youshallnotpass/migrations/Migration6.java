...
public final class Migration6 implements Migration {
    @Override
    public int number() {
        return 6;
    }
    ...
    public void execute(final Db db) throws JdException {
        ...
        db.write(
            new JdSql(
                "CREATE TABLE setterfree_violation (" +
                    "id TEXT NOT NULL PRIMARY KEY," +
                    "repo TEXT NOT NULL," +
        ...
        db.write(
            new JdSql(
                "CREATE TABLE nomultiplereturn_violation (" +
                    "id TEXT NOT NULL PRIMARY KEY," +
                    "repo TEXT NOT NULL," +
                    "description TEXT NOT NULL," +
                    "FOREIGN KEY(repo) REFERENCES repo(path) ON UPDATE CASCADE ON DELETE CASCADE" +
