...
import com.iwillfailyou.IwfyDb;
...
public class DbReposTest {
    ...
    public void okAfterFourMigration() throws Exception {
        ...
        final Repos thirdMigration = new DbRepos(new IwfyDb(db));
    ...
    public void addNullDescription() throws Exception {
        ...
        repos.repo("repo1").nullfree().violations().add(new IwfyViolation("null1"));
    ...
    public void clearNullDescriptions() throws Exception {
        ...
        nullfree.violations().add(new IwfyViolation("null1"));
